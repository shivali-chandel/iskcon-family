       ...
       // Add or Update Transaction Line Items
        if (itemData.item.length) {
          ...
          itemData.item.map((itm, row) => {
            ...
            console.log('i',i);
            console.log('len_array',len_array);
            if(i == len_array){
              let tot_sum= +sum;
              console.log('sum',tot_sum);
              console.log('itemData.total_amount',itemData.total_amount);
              net_amount = (itemData.total_amount - tot_sum).toFixed(2) ;
              console.log('net_amount1',net_amount);
            }else{
              net_amount = (net2*itemData.total_amount).toFixed(2);
              console.log('net_amount12',net_amount);
            }
