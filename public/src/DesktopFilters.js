...
async getPeriod ()  {
  ...
  clickNewsletter (event)  {
    ...
    // console.log('this filter', this.newsletter_filter);
    localStorage.setItem(
      "newsletter_filter",
      JSON.stringify(this.newsletter_filter)
    );

    // /news-letter/:year/:period_id
    this.props.history.push(`/news-letter/${this.state.year}/${this.state.period[0].id}`);
      ...
      /></a>
        ...
        <div>
          <div className="card" style={{marginTop:30}}>
                      ...
                      <div className="row" id="period_select">
                        ...
                        <div className="col-12 col-sm-6 col-lg-3">
                          <button
                            ...
                            style={{ marginTop: 15 }}
                            onClick={(event) => this.onButtonClickHandler(event)}
                          >
                            Generate Newsletter Iframe
                          </button>
                        </div>
                      </div>
                    </div>
              ...
              {this.state.showMessage ? <iframe src="https://sankirtan.dikonia.in" width="100%" height="600"></iframe> : null}
          </div>
        </div> : 
        <GenerateNewsLetter/>}
      </div>
